node {
        ...
        stage('Build image') {
            ...
            try {
                ...
                sh "docker buildx build --builder ${builder} --add-host packages.aurum.lan:${nginx_ip} --add-host pacman_cache.aurum.lan:${nginx_ip} -t kay/aurbuilder:latest --no-cache --pull ."
